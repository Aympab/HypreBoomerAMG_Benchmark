...
FIGURE EMILIA ICI OARJOB ENTRAIN DE tourner

tout est dans le rep log/bigjob
utiliser le parserdistance
...
Nous pouvons constater que ces paramètres fonctionnent aussi bien sur un plus
gros problème. De plus, le pic que nous avions obtenus en passant de 1 processus
à 2 disparait. Cependant, nous pouvons constater que les communications
inter-nodes semblent impacter grandement les performances.
